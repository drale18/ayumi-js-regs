...
Ayumi.prototype.setReg = function (index,value) {
	this.regs[index&0xf]=value&0xff;
	switch (index&0xf)
		{
		case 0:
			this.setTone(0,(this.regs[1]<<8)|this.regs[0]);
			break;
		case 1:
			this.setTone(0,(this.regs[1]<<8)|this.regs[0]);
			break;
		case 2:
			this.setTone(1,(this.regs[3]<<8)|this.regs[2]);
			break;
		case 3:
			this.setTone(1,(this.regs[3]<<8)|this.regs[2]);
			break;
		case 4:
			this.setTone(2,(this.regs[5]<<8)|this.regs[4]);
			break;
		case 5:
			this.setTone(2,(this.regs[5]<<8)|this.regs[4]);
			break;
		case 6:
			this.setNoise(this.regs[6]);
			break;
		case 7:
			this.setMixer(0,this.regs[7]&1,(this.regs[7]>>3)&1,this.regs[8]>>4);
			this.setMixer(1,(this.regs[7]>>1)&1,(this.regs[7]>>4)&1,this.regs[9]>>4);
			this.setMixer(2,(this.regs[7]>>2)&1,(this.regs[7]>>5)&1,this.regs[10]>>4);
			break;
		case 8:
			this.setMixer(0,this.regs[7]&1,(this.regs[7]>>3)&1,this.regs[8]>>4);
			this.setVolume(0,this.regs[8]&0xf);
			break;
		case 9:
			this.setMixer(1,(this.regs[7]>>1)&1,(this.regs[7]>>4)&1,this.regs[9]>>4);
			this.setVolume(1,this.regs[9]&0xf);
			break;
		case 10:
			this.setMixer(2,(this.regs[7]>>2)&1,(this.regs[7]>>5)&1,this.regs[10]>>4);
			this.setVolume(2,this.regs[10]&0xf);
			break;
		case 11:
			this.setEnvelope((this.regs[12]<<8)|this.regs[11]);
			break;
		case 12:
			this.setEnvelope((this.regs[12]<<8)|this.regs[11]);
			break;
		case 13:
			if (this.regs[13]!=255) this.setEnvelopeShape(this.regs[13]);
			break;
		}
	}
...
Ayumi.prototype.updateMixer = function() {
  ...
  for(var i = 0; i < this.channels.length; i++) {
    ...
    if (this.stereo) this.right += this.dacTable[out] * this.channels[i].panRight;
  }
}
...
Ayumi.prototype.process = function() {
  ...
  for(var i = DECIMATE_FACTOR - 1; i >= 0; i--) {
    ...
    if(this.x >= 1) {
      ...
      yLeft[3] = this.left;
      if (this.stereo) yRight[3] = this.right;
    ...
    if (this.stereo) firRight[i] = (cRight[2] * this.x + cRight[1]) * this.x + cRight[0];
  }

  this.left = this.decimate(firLeft);
  if (this.stereo) this.right = this.decimate(firRight);
}
...
Ayumi.prototype.removeDC = function() {
  ...
  if (this.stereo) this.right = this.dcFilter(this.dcFilterRight, this.dcIndex, this.right);
